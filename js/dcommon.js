function isPcOrPad() {
  ...
  //var ip_path = "http://10.1.84.118:8080";
 ...
 //var ip_path = "http://test.app.changfanz.net:3591";
  // var ip_path = "http://61.132.92.53:3589";
...
function hideOrShowjilu() {
  ...
  function pageSplit_d() {
    ...
    console.log(document.getElementById("barcon1_d"));
    document.getElementById("barcon1_d").innerHTML = tempStr;
  }
  ...
  if(appRoleList.indexOf($(window.parent.document).find("input[name='roleId']").val()) != -1){
    url = "/changfa_system/powerReport/queryPowerReportInfoForDealer.do";
  }else{
    url = "/changfa_system/powerReport/queryPowerReportInfo.do";
  }
  ...
  function ajax_area() {
    ...
    $.ajax({
      type: "post",
      async: false,
      url: ip_path + "/changfa_system/user/getUsersByPlace.do?type=1",
  ...
  function ajax_getyongtu() {
    $.ajax({
      ...
      success: function (data) {
        //console.log(data)
        for (var i = 0; i < data['body']['resultList']['length']; i++) {
          $("#yongtu").append("<option value='" + data['body']['resultList'][i]['number'] + "'>" + data['body']['resultList'][i]['name'] + "</option>");
        }
        $("#yongtu").unbind();
      }
    });
  ...
  function ajax_getleixing() {
    $.ajax({
      ...
      data: {
        type:1,
        machineModelNum: $("#yongtu option:selected").val(),
      },
      dataType: "json",
      success: function (data) {
        //console.log(data)
        for (var i = 0; i < data['body']['resultList']['length']; i++) {
          $("#leixing").append("<option value='" + data['body']['resultList'][i]['number'] + "'>" + data['body']['resultList'][i]['name'] + "</option>");
        }
        $("#leixing").unbind();
      }
    });
  ...
  function ajax_getconsumption() {
    $.ajax({
      ...
      success: function (data) {
        //console.log(data)
        for (var i = 0; i < data['body']['resultList']['length']; i++) {
          $("#consumption").append("<option value='" + data['body']['resultList'][i]['id'] + "'>" + data['body']['resultList'][i]['name'] + "</option>");
        }
        $("#consumption").unbind();
      }
    });
  ...
  function ajax_getpinpai() {
    $.ajax({
      ...
      data: {
        type:1,
        //productNum: $("#leixing option:selected").val(),
        matchMachineId: $("#leixing option:selected").val(),
      ...
      success: function (data) {
        //console.log(data)
        if(data['body']['resultList']['haveNext']==0){
          $("#pinpai").append("没有配套品牌")
        }
        else{
          for (var i = 0; i < data['body']['resultList']['length']; i++) {
            $("#pinpai").append("<option value='" + data['body']['resultList'][i]['number'] + "'>" + data['body']['resultList'][i]['name'] + "</option>");
          }
          $("#pinpai").unbind();
        }
  ...
  function ajax_getLineNum1() {
    $.ajax({
      ...
      success: function (data) {
        //console.log(data)
        $("#lineNum1").append("<option value='"+ 0 +"'>全部</option>");
        for (var i = 0; i < data['body']['resultList']['length']; i++) {
  ...
  function ajax_getSeriesNum1() {
    $.ajax({
      ...
      dataType: "json",
      success: function (data) {
        $("#seriesNum1").append("<option value='"+ 0 +"'>全部</option>");
        for (var i = 0; i < data['body']['resultList']['length']; i++) {
...
//报修农机
  ...
  function ajax_getSeriesNum() {
    $.ajax({
      ...
      dataType: "json",
      success: function (data) {
        $("#seriesNum").append("<option value=''>全部</option>");
        for (var i = 0; i < data['body']['resultList']['length']; i++) {
  ...
  function ajax_getModelNum() {
    $.ajax({
      ...
      dataType: "json",
      success: function (data) {
        $("#modelNum").append("<option value=''>全部</option>");
        for (var i = 0; i < data['body']['resultList']['length']; i++) {
...
function ajax_dealer_serverM1() {
  ...
  function ajax_socialServer_serverM1() {
    $.ajax({
      type: "post",
      url: ip_path + "/changfa_system/reportRepair/getReportRepairMan.do",
      data: {
        ...
        if (data['head']['code'] != 200) {
          ...
          for (var i = 0; i < data['body']['result']['data'].length; i++) {
            $("#adminTbody").append(
              ...
              '<td class="td2 txt_center" >' + data['body']['result']['data'][i]['machineModel'] + '</td>' +
              '<td class="td2 txt_center" >' + data['body']['result']['data'][i]['reportTime'] + '</td>' +
              '<td class="td2 txt_center" ><a href="###" class="color_cf" onclick="showRptDetails1(this)">查看</a></td>' +
              '</tr>'
            );
          }
          pageSplit();
  ...
  function ajax_CarCheck() {
    $.ajax({
      type: "post",
      async: false,
      url: ip_path + "/changfa_system/machineFlow/getFinalApprovalList.do",
      data: {
        pageNum: currentPage,
        pageSize: 14,
  ...
  //车辆报警信息
    //车辆报警信息
    function ajax_RskCheck1() {

  //判断经销商
  var url;
  if(appRoleList.indexOf($(window.parent.document).find("input[name='roleId']").val()) != -1){
    url = "/changfa_system/machineFlow/getAlertListForDealer.do";
  }else{
    url = "/changfa_system/machineFlow/getAlertList.do";
  }
      ...
      $.ajax({
        ...
        data: {
          ...
          bar_code: bar_code,
          status: $("#status").val(),
          machineStatus:$("#statusnj").val(),
          line_num: $("#product").val(),
          start_time: $("#date_start").val(),
          end_time: $("#date_end").val(),
          token: $(window.parent.document).find("input[name='token']").val(),
          alert_status:1,//0报警中,1已解除
        },
        dataType: "json",
        success: function (data) {
          if (data['head']['code'] != 200) {
            ...
            for (var i = 0; i < data['body']['result']['data'].length; i++) {
              ...
              $("#adminTbody").append(
                ...
                "<td class='td2' ><a href='###' class='color_cf' onclick='showrskCheckDetails1(this)'>查看</a></td>" +
  ...
  if(appRoleList.indexOf($(window.parent.document).find("input[name='roleId']").val()) != -1){
    ...
    $.ajax({
      ...
      data: {
        ...
        end_time: $("#date_end").val(),
        token: $(window.parent.document).find("input[name='token']").val(),
        alert_status:0,//0报警中,1已解除
        provinces :$('#rep_info_shenfen').val()
      },
      dataType: "json",
      success: function (data) {
        if (data['head']['code'] != 200) {
  ...
  var url;
  if(appRoleList.indexOf($(window.parent.document).find("input[name='roleId']").val()) != -1){
    console.log($(window.parent.document).find("input[name='roleId']").val())
    url = "/changfa_system/userMachine/queryUserAndMachineListNewForDealer.do";
  }else{
    console.log($(window.parent.document).find("input[name='roleId']").val(),appRoleList);
    url = "/changfa_system/userMachine/queryUserAndMachineListNew.do";
  }
      ...
      success: function (data) {
        ...
        if (data['head']['code'] != 200) {
          ...
          for (var i = 0; i < data['body']['result']['data'].length; i++) {
            ...
            //var shengfen;
            //if(data['body']['result']['data'][i]['province']){
            //  shengfen= data['body']['result']['data'][i]['province']
            //}else{
            //  shengfen='';
            //}
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data['head']['code'] != 200) {
          $("#adminTbody").empty();
          $("#adminTbody").append(
            '<td class="td2 txt_center" height="50px" colspan="11">未查到相关信息</td>'
          );
          document.getElementById("barcon1").innerHTML = "";
        } else {
          currentPage = data['body']['result']['pageNum'];
  ...
  function ajax_reportSum() {
    ...
    var url;
    if(appRoleList.indexOf($(window.parent.document).find("input[name='roleId']").val()) != -1){
      url = "/changfa_system/powerReport/powerReportDispatchExportForDealer.do";
    }else{
      url = "/changfa_system/powerReport/powerReportDispatchExport.do";
    }

    $.ajax({
      type: "post",
      //url: ip_path + "/changfa_system/reportRepair/reportDispatchExport.do",
      url: ip_path + url,
      data: {
        pageNum: currentPage,
        pageSize: 14,
  ...
  function ajax_repairSum() {
    ...
    var url;
    if(appRoleList.indexOf($(window.parent.document).find("input[name='roleId']").val()) != -1){
      url = "/changfa_system/powerRepair/powerRepairExportForDealer.do";
    }else{
      url = "/changfa_system/powerRepair/powerRepairExport.do";
    }

    $.ajax({
      type: "post",
      //url: ip_path + "/changfa_system/repair/repairExport.do",
      url: ip_path + url,
      data: {
        pageNum: currentPage,
        pageSize: 14,
  ...
  function ajax_dealersUnderSaler() {
    $.ajax({
      type: "post",
      async: false,
      url: ip_path + "/changfa_system/account/queryDealer.do",
      data: {
        userId: $(window.parent.document).find("input[name='salerId']").val(),
        province: $("#taskAddress").text(),
        pageSize: 7,
        pageNum: currentPage
      },
      dataType: "json",
        ...
        if (data['head']['code'] != 200) {
          ...
          for (var i = 0; i < data['body']['result']['data'].length; i++) {
            ...
            $("#adminTbody").append(
              ...
              '<td class="td2" >上架：<img src="' + on_off_path_status + '" class="vert_mid mg-r20" onclick="changeGoodsTags(this)">置顶：<img src="' + on_off_path_isTop + '" class="vert_mid mg-r20" onclick="changeGoodsTags(this)"></td>' +
  ...
  function ajax_sendOrderM() {
    $.ajax({
      type: "post",
      url: ip_path + "/changfa_system/deliver/queryInvoices.do",
      data: {
        pageNum: currentPage,
        pageSize: 14,
        chooseItem: $("#sendM_item option:selected").val(),
        ...
        if (data['head']['code'] != 200) {
          ...
          for (var i = 0; i < data['body']['result']['machineList']['data'].length; i++) {
            ...
            if (data['body']['result']['machineList']['data'][i]['meetingStatus'] == 1) {
              status = "未接车";
              $("#adminTbody").append(
                "<tr id =" + data['body']['result']['machineList']['data'][i]['machineId'] + ">" +
                ...
                '<td class="td2 txt_center" >' + status + '</td>' +
                '<td class="td2 txt_center" ><a href="###" class="color_cf" onclick="showSendDetails(this)">查看</a></td>' +
        ...
        if (data['head']['code'] != 200) {
          ...
          for (var i = 0; i < data['body']['result']['data'].length; i++) {
            ...
            $("#adminTbody").append(
              ...
              '<td class="td2 txt_center" ><a href="###" class="color_cf" onclick="menuLimitSet(this)">权限设置</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="###" class="color_cf" onclick="modifyRole(this)">编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="###" style="color:red" onclick="delRole(this)">删除</a></td>' +
              '</tr>'
            );
          }
          pageSplit();
        ...
        if (data['head']['code'] != 200) {
          ...
          for (var i = 0; i < data['body']['result']['data'].length; i++) {
            ...
            $("#adminTbody").append(
              ...
              '<td class="td2" data-name ="'+ data['body']['result']['data'][i]['isCertifiedOwner'] +'" data-id ="'+ data['body']['result']['data'][i]['userId'] +'" onclick="bannedfy1(this)" style="color:#1ABC9C;cursor:pointer;">'+'标记'+'</td>' +
              '<td class="td2">'+
              '<a  class="jinyanid" data-id ="'+ data['body']['result']['data'][i]['userId'] +'" onclick="bannedfy(this)"  style="color:#1ABC9C;cursor:pointer;">'+'禁言'+'</a>'+
              '</td>' +
              '</tr>'
            );
          }
  ...
  //标记查询
function bannedfy1(obj){
  //alert($(obj).attr('data-name'))
  $('.bannerclick1').css('display','block');
  $(".david").val($(obj).attr('data-id'));
  $(".guanfang").val($(obj).attr('data-name'));
  $("#checkin10").attr("checked",false);
  $("#checkin11").attr("checked",false);
  if($(obj).attr('data-name')==1){
    $("#checkin10").attr("checked",true);
  }else if($(obj).attr('data-name')==2){
    $("#checkin11").attr("checked",true);
  }
  ...
  //标记确认
  var status;
  function confirmqr1(obj){
      if($("#checkin10").attr("checked")) {
        status = 1;
      }
      if($("#checkin11").attr("checked")) {
        status = 2;
      }
      if(!$("#checkin10").attr("checked") && !$("#checkin11").attr("checked")){
        status = 0;
      }
      if($("#checkin10").attr("checked") && $("#checkin11").attr("checked")){
        alert('大V认证和官方认证不能同时勾选');
        $('.bannerclick1').css('display','none');
        return false;
      }
      $.ajax({
        type : "post",
   ...
   //var userId;
   function bannedfy(obj){
    $('.bannerclick').css('display','block');
    //userId = $(this).data('id');
    $(".jyid").val($(obj).attr('data-id'));
    $(".jyfatie").val($(obj).attr('data-id'));
    $("#checkin8").attr("checked",false);
    $("#checkin8").val(1);
    $("#checkin9").attr("checked",false);
    $("#checkin9").val(2);
    //发帖查询黑名单
    $.ajax({
      type: "post",
      url: ip_path + "/changfa_system/blacklist/getBlacklistByUserIdAndStatus.do",
      data: {
      ...
      success: function (data) {
        //console.log(data)    
        if(data['head']['code'] == 200) {
          $("#checkin8").attr("checked",true);
            $("#checkin8").val(3);
          $("#checkin8").attr("data-id",data['body']['result']['id']);
        } 
    ...
    $.ajax({
      ...
      success: function (data) {
        //console.log(data) 
        if(data['head']['code'] == 200) {
          $("#checkin9").attr("checked",true);
          $("#checkin9").val(4);
          $("#checkin9").attr("data-id",data['body']['result']['id']);
        }
  ...
  //确认
  function confirmqr(obj){
      //let ft = $("#checkin9").attr("checked");
      //let pl = $("#checkin9").val();
      let id = "";
      let t = "";
      let status = [];
      if($("#checkin8").attr("checked")) {
        id = 0;
      } else {
        id = 1;
      }
	    status.push(id);
      if($("#checkin9").attr("checked")) {
        t=0;
      } else {
        t = 1;
      }
      ...
      $.ajax({
        type: "post",
        contentType: 'application/json',
        url: ip_path + "/changfa_system/blacklist/addBlacklist.do",
        data: JSON.stringify(json),
        dataType: "json",
        success: function (data) {
          if(data['head']['code']==200){
  ...
  function fatie(obj){
    //发帖添加黑名单
    let dqstatus = $(obj).val();
    if(dqstatus == 3) {
      $.ajax({
        type: "post",
        url: ip_path + "/changfa_system/blacklist/deleteById.do",
        data: {
          //token: $(window.parent.document).find("input[name='token']").val(),
          id:$(obj).attr("data-id")
        },
...
*/
  ...
  function ajax_fastRpt1() {
    ...
    $.ajax({
      ...
      async: false,
      //url: ip_path + "/changfa_system/reportRepair/queryReportInfo.do",
      url: ip_path + "/changfa_system/powerReport/queryPowerReportInfo.do",
      data: {
        startTime: begin_time,
        endTime: end_time,
  ...
  function ajax_salePlanM() {
    $.ajax({
      type: "post",
      async: false,
      url: ip_path + "/changfa_system/config/selectSalePlan.do",
      data: {
        lineNum: $("#line option:selected").val(),
  ...
  function ajax_saleOrderM() {
    $.ajax({
      type: "post",
      async: false,
      url: ip_path + "/changfa_system/config/selectSaleOrder.do",
      data: {
        lineNum: $("#line option:selected").val(),
        chooseItem: $("#order_item option:selected").val(),
        itemCont: $("#order_info").val(),
  ...
  function ajax_autoDisM() {
    $.ajax({
      type: "post",
      url: ip_path + "/changfa_system/powerAutoDispatchRule/queryAutoPowerDispatchRule.do",
      data: {
        pageNum: currentPage,
        pageSize: 14,
        status: $("#status option:selected").val()
  ...
  //三包配件维护
  function ajax_sbpjfw(){
    //yemiantoogle();
    var dgjnumber = $(".hqname").attr("data-number");
    var dqym = $(".dqym").val()*1+1;
    $.ajax({
      type: "post",
          ...
          for(var i=0;i< data['body']['result']['data']['length']; i++ ){
            ...
            $('#adminTbody').append(
              '<tr text-align="center" class="'+i+'">'+
                   '<td height="33" id="ridao" class="th2" style="">'+
