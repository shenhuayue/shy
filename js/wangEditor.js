            ...
            if (customUploadVideo && typeof customUploadVideo === 'function') {
                var obj = {
                    callback:function (url) {
                        editor.cmd.do('insertHTML', '<video src="'+url+'" style="width: 100%;height:100%;" controls autobuffer />');
                        // editor.cmd.do('insertHTML', '<video muted src="'+url+'" style="width: 100%;height:100%;" autoplay webkit-playsinline playsinline webview.allowsInlineMediaPlayback = YES loop x5-video-player-type="h5" />');
                        // editor.cmd.do('insertHTML', '<video controls="controls" style="width: 100%;height:100%;" class="video">'+ 
                        //                                 '<source src="'+url+'" type="video/mov" controls="controls" webkit-playsinline="true" playsinline="true" x5-playsinline="true" x-webkit-airplay="allow"  >'+
                        //                                 '<source src="'+url+'" type="video/ogg" codecs="theora,vorbis" controls="controls" webkit-playsinline="true" playsinline="true" x5-playsinline="true" x-webkit-airplay="allow"  >'+
                        //                                 '<source src="'+url+'" type="video/mp4" codecs="avc1.42E01E,mp4a.40.2" controls="controls" webkit-playsinline="true" playsinline="true" x5-playsinline="true" x-webkit-airplay="allow"  >'+
                        //                             '</video>' );
                    }
                }
